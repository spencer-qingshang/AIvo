...
public class AbstractExample {
    public static void main(String[] args) {
        ...
        System.out.print("狗的行为: ");     // 输出: 狗的行为: 
        myDog.makeSound();                // 输出: 汪汪！
        myDog.sleep();                    // 输出: Zzzz... (正在睡觉)
        
        System.out.print("猫的行为: ");     // 输出: 猫的行为: 
        myCat.makeSound();                // 输出: 喵~
        myCat.sleep();                    // 输出: Zzzz... (正在睡觉)
    }
}
```
...
public class InterfaceExample {
    public static void main(String[] args) {
        ...
        System.out.println("鸟的能力:"); // 输出: 鸟的能力:
        bird.fly();                   // 输出: 鸟在天上扇动翅膀飞。
        
        System.out.println("\n鸭子的能力:"); // 输出: (换行) 鸭子的能力:
        duck.fly();                      // 输出: 鸭子也能扑腾着飞一会儿。
        duck.swim();                     // 输出: 鸭子在水里熟练地游泳。
    }
}
```
...
public class TryCatchFinallyExample {
    public static void main(String[] args) {
        try {
            // 1. try 块：包裹可能发生异常的代码
            System.out.println("准备执行除法..."); // 输出: 准备执行除法...
            ...
            System.out.println("捕获到异常！错误信息: " + e.getMessage()); // 输出: 捕获到异常！错误信息: / by zero
            
        } finally {
            // 3. finally 块：无论是否发生异常，这里的代码最终总会执行
            System.out.println("finally 块被执行，程序结束。"); // 输出: finally 块被执行，程序结束。
        }
    }
}
```
...
public class ThrowsAndThrowExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            setAge(25);  // 输出: 年龄设置成功: 25
            setAge(-5); // 这一次调用会抛出异常
        } catch (IllegalArgumentException e) {
            System.out.println("捕获到从 setAge 方法抛出的异常: " + e.getMessage()); // 输出: 捕获到从 setAge 方法抛出的异常: 年龄必须在 0 到 150 之间！
        }

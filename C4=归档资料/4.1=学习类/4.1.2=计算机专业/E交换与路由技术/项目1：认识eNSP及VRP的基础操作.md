...
1.  了解 eNSP 模拟器的作用；
2.  了解 VRP 操作系统的来源和发展；
3.  认识 eNSP 主界面和网络连接的线缆；
4.  熟悉 VRP 的命令视图和基本操作。

### 1.2 考核知识点与考核要求
*   **识记**：了解 eNSP 模拟器的作用；了解 VRP 操作系统的来源和发展；认识 eNSP 主界面和网络连接的线缆。
*   **领会**：熟悉 VRP 的命令和基本操作。
*   **应用**：能正确安装 eNSP 模拟器；能使用 eNSP 搭建和配置网络；能掌握 VRP 平台的应用；能熟悉 VRP 基本操作。

### 1.3 本章重点、难点
*   **教学重点**：eNSP 模拟器的安装步骤、添加网络设备和连接设备线缆。
*   **教学难点**：eNSP 模拟器的安装。
*   **学习难点**：熟练掌握 VRP 的相关命令语句。
